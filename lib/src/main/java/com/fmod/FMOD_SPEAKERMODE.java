...
public final class FMOD_SPEAKERMODE {
  ...
  public final static FMOD_SPEAKERMODE FMOD_SPEAKERMODE_7POINT1POINT4 = new FMOD_SPEAKERMODE("FMOD_SPEAKERMODE_7POINT1POINT4");
  public final static FMOD_SPEAKERMODE FMOD_SPEAKERMODE_MAX = new FMOD_SPEAKERMODE("FMOD_SPEAKERMODE_MAX");
  public final static FMOD_SPEAKERMODE FMOD_SPEAKERMODE_FORCEINT = new FMOD_SPEAKERMODE("FMOD_SPEAKERMODE_FORCEINT", FMODStudioJNI.FMOD_SPEAKERMODE_FORCEINT_get());
  ...
  private static FMOD_SPEAKERMODE[] swigValues = { FMOD_SPEAKERMODE_DEFAULT, FMOD_SPEAKERMODE_RAW, FMOD_SPEAKERMODE_MONO, FMOD_SPEAKERMODE_STEREO, FMOD_SPEAKERMODE_QUAD, FMOD_SPEAKERMODE_SURROUND, FMOD_SPEAKERMODE_5POINT1, FMOD_SPEAKERMODE_7POINT1, FMOD_SPEAKERMODE_7POINT1POINT4, FMOD_SPEAKERMODE_MAX, FMOD_SPEAKERMODE_FORCEINT };
