...
public final class FMOD_RESULT {
  ...
  public final static FMOD_RESULT FMOD_ERR_RECORD_DISCONNECTED = new FMOD_RESULT("FMOD_ERR_RECORD_DISCONNECTED");
  public final static FMOD_RESULT FMOD_ERR_TOOMANYSAMPLES = new FMOD_RESULT("FMOD_ERR_TOOMANYSAMPLES");
  public final static FMOD_RESULT FMOD_RESULT_FORCEINT = new FMOD_RESULT("FMOD_RESULT_FORCEINT", FMODStudioJNI.FMOD_RESULT_FORCEINT_get());
