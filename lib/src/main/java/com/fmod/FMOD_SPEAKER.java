...
public final class FMOD_SPEAKER {
  public final static FMOD_SPEAKER FMOD_SPEAKER_NONE = new FMOD_SPEAKER("FMOD_SPEAKER_NONE", FMODStudioJNI.FMOD_SPEAKER_NONE_get());
  public final static FMOD_SPEAKER FMOD_SPEAKER_FRONT_LEFT = new FMOD_SPEAKER("FMOD_SPEAKER_FRONT_LEFT", FMODStudioJNI.FMOD_SPEAKER_FRONT_LEFT_get());
  ...
  public final static FMOD_SPEAKER FMOD_SPEAKER_TOP_FRONT_LEFT = new FMOD_SPEAKER("FMOD_SPEAKER_TOP_FRONT_LEFT");
  public final static FMOD_SPEAKER FMOD_SPEAKER_TOP_FRONT_RIGHT = new FMOD_SPEAKER("FMOD_SPEAKER_TOP_FRONT_RIGHT");
  public final static FMOD_SPEAKER FMOD_SPEAKER_TOP_BACK_LEFT = new FMOD_SPEAKER("FMOD_SPEAKER_TOP_BACK_LEFT");
  public final static FMOD_SPEAKER FMOD_SPEAKER_TOP_BACK_RIGHT = new FMOD_SPEAKER("FMOD_SPEAKER_TOP_BACK_RIGHT");
  public final static FMOD_SPEAKER FMOD_SPEAKER_MAX = new FMOD_SPEAKER("FMOD_SPEAKER_MAX");
  public final static FMOD_SPEAKER FMOD_SPEAKER_FORCEINT = new FMOD_SPEAKER("FMOD_SPEAKER_FORCEINT", FMODStudioJNI.FMOD_SPEAKER_FORCEINT_get());
