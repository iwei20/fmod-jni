...
public final class FMOD_SOUND_TYPE {
  ...
  public final static FMOD_SOUND_TYPE FMOD_SOUND_TYPE_OPUS = new FMOD_SOUND_TYPE("FMOD_SOUND_TYPE_OPUS");
  public final static FMOD_SOUND_TYPE FMOD_SOUND_TYPE_MAX = new FMOD_SOUND_TYPE("FMOD_SOUND_TYPE_MAX");
  public final static FMOD_SOUND_TYPE FMOD_SOUND_TYPE_FORCEINT = new FMOD_SOUND_TYPE("FMOD_SOUND_TYPE_FORCEINT", FMODStudioJNI.FMOD_SOUND_TYPE_FORCEINT_get());
