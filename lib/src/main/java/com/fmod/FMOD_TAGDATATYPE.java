...
public final class FMOD_TAGDATATYPE {
  public final static FMOD_TAGDATATYPE FMOD_TAGDATATYPE_BINARY = new FMOD_TAGDATATYPE("FMOD_TAGDATATYPE_BINARY");
  ...
  public final static FMOD_TAGDATATYPE FMOD_TAGDATATYPE_FORCEINT = new FMOD_TAGDATATYPE("FMOD_TAGDATATYPE_FORCEINT", FMODStudioJNI.FMOD_TAGDATATYPE_FORCEINT_get());
  ...
  private static FMOD_TAGDATATYPE[] swigValues = { FMOD_TAGDATATYPE_BINARY, FMOD_TAGDATATYPE_INT, FMOD_TAGDATATYPE_FLOAT, FMOD_TAGDATATYPE_STRING, FMOD_TAGDATATYPE_STRING_UTF16, FMOD_TAGDATATYPE_STRING_UTF16BE, FMOD_TAGDATATYPE_STRING_UTF8, FMOD_TAGDATATYPE_MAX, FMOD_TAGDATATYPE_FORCEINT };
