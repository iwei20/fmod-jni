...
/**
 * Represents native error codes returned by every function in
 * native FMOD. The corresponding error messages can be found in
 * {@link FMODException#FMOD_ERR_MESSAGES}.
 */
