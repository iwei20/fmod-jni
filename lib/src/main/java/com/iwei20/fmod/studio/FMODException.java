...
public class FMODException extends RuntimeException {
    ...
    /**
     * This is a map from error codes -> messages.
     */
    private static final String[] FMOD_ERR_MESSAGES = {
        "No errors.",
    ...
    public static void errCheck(int code) {
        ...
        if (code > 0 && code < FMOD_ERR_MESSAGES.length) {
            throw new FMODException(FMOD_ERR_MESSAGES[code]);
        }
