...
public class FMOD_ASYNCREADINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_studio_h.C_POINTER.withName("handle"),
        fmod_studio_h.C_INT.withName("offset"),
        fmod_studio_h.C_INT.withName("sizebytes"),
        fmod_studio_h.C_INT.withName("priority"),
        MemoryLayout.paddingLayout(4),
        fmod_studio_h.C_POINTER.withName("userdata"),
        fmod_studio_h.C_POINTER.withName("buffer"),
        fmod_studio_h.C_INT.withName("bytesread"),
        MemoryLayout.paddingLayout(4),
        fmod_studio_h.C_POINTER.withName("done")
    ...
    public final static class done {
        ...
        private static final MethodHandle UP$MH = fmod_studio_h.upcallHandle(done.Function.class, "apply", $DESC);
