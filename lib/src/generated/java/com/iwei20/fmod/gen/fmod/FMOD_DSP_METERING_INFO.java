...
public class FMOD_DSP_METERING_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_INT.withName("numsamples"),
        MemoryLayout.sequenceLayout(32, fmod_h.C_FLOAT).withName("peaklevel"),
        MemoryLayout.sequenceLayout(32, fmod_h.C_FLOAT).withName("rmslevel"),
        fmod_h.C_SHORT.withName("numchannels"),
