...
public class FMOD_ADVANCEDSETTINGS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_INT.withName("cbSize"),
        fmod_h.C_INT.withName("maxMPEGCodecs"),
        fmod_h.C_INT.withName("maxADPCMCodecs"),
        fmod_h.C_INT.withName("maxXMACodecs"),
        fmod_h.C_INT.withName("maxVorbisCodecs"),
        fmod_h.C_INT.withName("maxAT9Codecs"),
        fmod_h.C_INT.withName("maxFADPCMCodecs"),
        fmod_h.C_INT.withName("maxOpusCodecs"),
        fmod_h.C_INT.withName("ASIONumChannels"),
        MemoryLayout.paddingLayout(4),
        fmod_h.C_POINTER.withName("ASIOChannelList"),
        fmod_h.C_POINTER.withName("ASIOSpeakerList"),
        fmod_h.C_FLOAT.withName("vol0virtualvol"),
        fmod_h.C_INT.withName("defaultDecodeBufferSize"),
        fmod_h.C_SHORT.withName("profilePort"),
        MemoryLayout.paddingLayout(2),
        fmod_h.C_INT.withName("geometryMaxFadeTime"),
        fmod_h.C_FLOAT.withName("distanceFilterCenterFreq"),
        fmod_h.C_INT.withName("reverb3Dinstance"),
        fmod_h.C_INT.withName("DSPBufferPoolSize"),
        fmod_h.C_INT.withName("resamplerMethod"),
        fmod_h.C_INT.withName("randomSeed"),
        fmod_h.C_INT.withName("maxConvolutionThreads"),
        fmod_h.C_INT.withName("maxSpatialObjects"),
        MemoryLayout.paddingLayout(4)
