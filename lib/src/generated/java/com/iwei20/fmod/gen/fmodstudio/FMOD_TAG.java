...
public class FMOD_TAG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        fmod_studio_h.C_INT.withName("datatype"),
        fmod_studio_h.C_POINTER.withName("name"),
        fmod_studio_h.C_POINTER.withName("data"),
        fmod_studio_h.C_INT.withName("datalen"),
        fmod_studio_h.C_INT.withName("updated")
    ).withName("FMOD_TAG");
    ...
    private static final long datalen$OFFSET = $LAYOUT.byteOffset(groupElement("datalen"));
    ...
    private static final long updated$OFFSET = $LAYOUT.byteOffset(groupElement("updated"));
