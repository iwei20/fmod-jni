...
public class FMOD_DSP_LOUDNESS_METER_INFO_TYPE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_FLOAT.withName("momentaryloudness"),
        fmod_h.C_FLOAT.withName("shorttermloudness"),
        fmod_h.C_FLOAT.withName("integratedloudness"),
        fmod_h.C_FLOAT.withName("loudness10thpercentile"),
        fmod_h.C_FLOAT.withName("loudness95thpercentile"),
        MemoryLayout.sequenceLayout(66, fmod_h.C_FLOAT).withName("loudnesshistogram"),
        fmod_h.C_FLOAT.withName("maxtruepeak"),
        fmod_h.C_FLOAT.withName("maxmomentaryloudness")
