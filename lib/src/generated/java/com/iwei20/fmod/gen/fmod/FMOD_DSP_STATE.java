...
public class FMOD_DSP_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_POINTER.withName("instance"),
        fmod_h.C_POINTER.withName("plugindata"),
        fmod_h.C_INT.withName("channelmask"),
        fmod_h.C_INT.withName("source_speakermode"),
        fmod_h.C_POINTER.withName("sidechaindata"),
        fmod_h.C_INT.withName("sidechainchannels"),
        MemoryLayout.paddingLayout(4),
        fmod_h.C_POINTER.withName("functions"),
        fmod_h.C_INT.withName("systemobject"),
        MemoryLayout.paddingLayout(4)
