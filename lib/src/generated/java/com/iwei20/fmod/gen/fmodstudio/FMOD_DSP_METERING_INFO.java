...
public class FMOD_DSP_METERING_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_studio_h.C_INT.withName("numsamples"),
        MemoryLayout.sequenceLayout(32, fmod_studio_h.C_FLOAT).withName("peaklevel"),
        MemoryLayout.sequenceLayout(32, fmod_studio_h.C_FLOAT).withName("rmslevel"),
        fmod_studio_h.C_SHORT.withName("numchannels"),
    ...
    private static final long numsamples$OFFSET = $LAYOUT.byteOffset(groupElement("numsamples"));
    ...
    private static final long peaklevel$OFFSET = $LAYOUT.byteOffset(groupElement("peaklevel"));
    ...
    private static final long rmslevel$OFFSET = $LAYOUT.byteOffset(groupElement("rmslevel"));
