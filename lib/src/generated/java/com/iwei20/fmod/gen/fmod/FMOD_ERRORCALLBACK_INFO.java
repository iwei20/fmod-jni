...
public class FMOD_ERRORCALLBACK_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_INT.withName("result"),
        fmod_h.C_INT.withName("instancetype"),
        fmod_h.C_POINTER.withName("instance"),
        fmod_h.C_POINTER.withName("functionname"),
        fmod_h.C_POINTER.withName("functionparams")
    ...
    private static final long functionparams$OFFSET = $LAYOUT.byteOffset(groupElement("functionparams"));
