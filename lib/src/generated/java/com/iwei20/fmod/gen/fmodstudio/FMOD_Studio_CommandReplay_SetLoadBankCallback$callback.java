 ...
 * }
 */
public final class FMOD_Studio_CommandReplay_SetLoadBankCallback$callback {

    private FMOD_Studio_CommandReplay_SetLoadBankCallback$callback() {
    ...
    private static final MethodHandle UP$MH = fmod_studio_h.upcallHandle(FMOD_Studio_CommandReplay_SetLoadBankCallback$callback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(FMOD_Studio_CommandReplay_SetLoadBankCallback$callback.Function fi, Arena arena) {
