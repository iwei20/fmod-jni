...
public class FMOD_DSP_PARAMETER_OVERALLGAIN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_studio_h.C_FLOAT.withName("linear_gain"),
        fmod_studio_h.C_FLOAT.withName("linear_gain_additive")
    ...
    private static final long linear_gain$OFFSET = $LAYOUT.byteOffset(groupElement("linear_gain"));
    ...
    private static final long linear_gain_additive$OFFSET = $LAYOUT.byteOffset(groupElement("linear_gain_additive"));
