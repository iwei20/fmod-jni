...
public class FMOD_OUTPUT_OBJECT3DINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        fmod_studio_h.C_INT.withName("bufferlength"),
        FMOD_VECTOR.layout().withName("position"),
        fmod_studio_h.C_FLOAT.withName("gain"),
        fmod_studio_h.C_FLOAT.withName("spread"),
        fmod_studio_h.C_FLOAT.withName("priority"),
    ...
    private static final long gain$OFFSET = $LAYOUT.byteOffset(groupElement("gain"));
    ...
    private static final long spread$OFFSET = $LAYOUT.byteOffset(groupElement("spread"));
