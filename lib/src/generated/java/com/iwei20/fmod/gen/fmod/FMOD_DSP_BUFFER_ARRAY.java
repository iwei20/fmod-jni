...
public class FMOD_DSP_BUFFER_ARRAY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_INT.withName("numbuffers"),
        MemoryLayout.paddingLayout(4),
        fmod_h.C_POINTER.withName("buffernumchannels"),
        fmod_h.C_POINTER.withName("bufferchannelmask"),
        fmod_h.C_POINTER.withName("buffers"),
        fmod_h.C_INT.withName("speakermode"),
        MemoryLayout.paddingLayout(4)
