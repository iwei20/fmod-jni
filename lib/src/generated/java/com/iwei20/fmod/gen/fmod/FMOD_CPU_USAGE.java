...
public class FMOD_CPU_USAGE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        fmod_h.C_FLOAT.withName("dsp"),
        fmod_h.C_FLOAT.withName("stream"),
        fmod_h.C_FLOAT.withName("geometry"),
        fmod_h.C_FLOAT.withName("update"),
        fmod_h.C_FLOAT.withName("convolution1"),
        fmod_h.C_FLOAT.withName("convolution2")
